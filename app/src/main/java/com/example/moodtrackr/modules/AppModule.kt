...
import com.example.moodtrackr.repositories.CustomMoodsRepository
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideICustomMoodsRepository(context: Context): ICustomMoodsRepository {
        return CustomMoodsRepository(context)
    }

    @Provides
    @Singleton
    fun provideMoodEntryCustomMoodsRepository(context: Context): com.example.moodtrackr.repositories.MoodEntryCustomMoodsRepository {
        return com.example.moodtrackr.repositories.MoodEntryCustomMoodsRepository(context)
    }
